...
// Tsai 20180913: 通过index返回一个CBaseEntity指针，只有是玩家出生或者连接才返回有效值，其它时候返回null，默认index是1
...
// Tsai 20180913: 从监听服务器获取本地玩家，只在多人时使用
// 
CBasePlayer *UTIL_GetListenServerHost( void )
{
	// no "local player" if this is a dedicated server or a single player game
	// Tsai 20180913：如果是专用服务器或者单玩家游戏则没有"local player"
